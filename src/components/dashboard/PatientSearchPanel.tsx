                    ...
                    <div className="flex text-sm font-medium bg-slate-50">
                        ...
                        >
                            ...
                            <div className="flex gap-1 ml-1">
                                {delayedCount > 0 && (
                                    <span className="bg-red-500 text-white text-xs px-1.5 rounded-full animate-pulse" title="カルテ未作成">
                                        {delayedCount}
                                    </span>
                                )}
                                {unassignedCount > 0 && (
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <ul className="space-y-1">
                                                    {delayedAppointments.map(apt => (
                                                        <li
                                                            key={apt.id}
                                                            className="p-3 bg-white border border-blue-200 rounded-md shadow-sm cursor-pointer hover:shadow-md hover:border-blue-400 transition-all group"
                                                        >
                                                            <div className="flex items-center justify-between">
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div>
                                                                        <Link href={`/patients/${apt.patientId}`} className="font-bold text-slate-800 text-sm hover:underline hover:text-indigo-600 block">
                                                                            {apt.patientName}
                                                                        </Link>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="p-2 bg-slate-50 text-slate-400 rounded-full hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                                                                    title="完了して消込"
                                                                >
