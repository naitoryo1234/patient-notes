                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                required
                                className="border rounded px-3 py-2 text-sm flex-1 focus:ring-2 focus:ring-indigo-500 outline-none"
                            />
                            <select
                                value={time}
                                onChange={(e) => setTime(e.target.value)}
                                required
                                className="border rounded px-2 py-2 text-sm w-24 focus:ring-2 focus:ring-indigo-500 outline-none"
                            >
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <button type="button" onClick={setToday} className="text-xs bg-slate-100 hover:bg-slate-200 px-2 py-1 rounded text-slate-600 border border-slate-200">今日</button>
                            <button type="button" onClick={setTomorrow} className="text-xs bg-slate-100 hover:bg-slate-200 px-2 py-1 rounded text-slate-600 border border-slate-200">明日</button>
                            <button type="button" onClick={setNextWeek} className="text-xs bg-slate-100 hover:bg-slate-200 px-2 py-1 rounded text-slate-600 border border-slate-200">来週</button>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            rows={2}
                            className="border rounded px-3 py-2 text-sm w-full focus:ring-2 focus:ring-indigo-500 outline-none resize-none"
                            placeholder={LABELS.FORM.MEMO_PATIENT_PLACEHOLDER}
                        />
                    </div>

                    {/* Admin Memo */}
                    <div className="bg-red-50 p-3 rounded-md border border-red-100 space-y-2">
                        ...
                        <textarea
                            ...
                            rows={2}
                            className="border border-red-200 rounded px-3 py-2 text-sm w-full bg-white focus:ring-2 focus:ring-red-500 outline-none resize-none"
